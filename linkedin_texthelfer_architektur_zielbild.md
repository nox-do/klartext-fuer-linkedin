...
| **AP10** | **in Arbeit** | Golden Cases: `tests/fixtures/golden-recommendation-cases.mjs` + `tests/unit/golden-recommendations.test.js`; aktuell **36 Fälle** (Feed/Baseline/Risk + `invite/headline/article`, inkl. DE/EN-Mix), Includes/Excludes/Top-3 + Anti-FP/FN (u. a. URL-Query-`?`, kurzer Frage-Text, Prefix-Excludes bei Risk); `verify.mjs golden`. |
...
- [x] Start-Set (36 Cases) mit realistischen Feed-/Risk-/Baseline-Szenarien
