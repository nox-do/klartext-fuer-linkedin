  ...
  if (post.structure.ctaStrength < 0.2 && post.metrics.charCount > 400) {
    out.push(
      rec({
        ...
        message: "Bei laengeren Feed-Posts hilft oft eine konkrete Abschlussfrage fuer Anschluss.",
        action: "Ergaenze eine Frage, die mit Ja/Nein nicht beantwortbar ist.",
        topicBucket: "cta",
  ...
  if (
    ...
    out.push(
      rec({
        ...
        level: "hint",
        priority: 58,
        title: "Kernthese kommt spaet",
        message: "Dein staerkster Punkt erscheint spaet und verliert fruehe Aufmerksamkeit.",
